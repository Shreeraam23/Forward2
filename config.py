...
class Config:
    API_ID = int(environ.get("API_ID", "28036362"))
    API_HASH = environ.get("API_HASH", "84e4bd8457dab2f065801bde8874842a")
    BOT_TOKEN = environ.get("BOT_TOKEN", "7552442021:AAFgA-JkfEwKtg38MwPk-aglx0kCnUf5VAc") 
    ...
    BOT_OWNER = int(environ.get("BOT_OWNER", "7782401729"))
